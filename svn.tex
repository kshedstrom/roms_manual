...
In order download source code from a Subversion repository, svn
...
to \code{User/Functionals/ana\_hmixcoef.h}. Now you want to update your
...
open \code{User/Functionals/ana\_hmixcoef.h} in your favorite editor and
