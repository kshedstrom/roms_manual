...
in combination with the Flather condition on the 2-D momentum equations.
\begin{equation}
...
proposed a radiation scheme in which a local phase velocity is
...
directions are accounted for (with the recommended \code{RADIATION_2D}
option):
\begin{equation}
