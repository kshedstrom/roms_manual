...
myroms.org), (b) ROMS AGRIF, (c) UCLA ROMS, described in \citet{SS2005},
(d) non-hydrostatic ROMS \citep{Kanarska2007}. In all, the curved
...
\begin{tabular}{|l|c|c|c|c|c|} \hline
  ...
  \hline
  Reference & \citet{Hedstrom2000} & \citet{DAMEE_1} &
  \citet{Penven2006} & \citet{SS2005} & \citet{Kanarska2007} \\
  \hline
...
%errors when $|\nabla h|$ is large \citep{Haney,BH93}. Shchepetkin....
...
by \citep{Chapman85}, assuming all outgoing signals leave
