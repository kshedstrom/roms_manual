...
the squared root of the biharmonic viscosity coefficient (Griffies
...
Umlauf and Burchard (\cite{Umlauf2003}) have come up with a generic
...
Warner et al. (\cite{Warner_2005}). Its parameters are set in the
ROMS input file.
...
solution procedure can be found in any standard reference, such as Press
et al.\ \cite{PFTV}.
