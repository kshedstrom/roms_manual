...
\begin{klist}
   ...
   \kitem{Grid-dimension parameters} \mbox{}
     ...
     \end{klist}
   \kitem{Domain-docomposition parameters} \mbox{}
     \begin{klist}
   ...
   \kitem{History, average, diagnostic output parameters} \mbox{}
     ...
     \end{klist}
    \kitem{Tangent lienar and adjoint output parameters} \mbox{}
     \begin{klist}
   ...
   \mbox{}
     ...
     \end{klist}
   \kitem{Contants used in surface TKE flux computation} \mbox{}
     \begin{klist}
  ...
  \kitem{Nudging time scales} \mbox{}
   ...
   \kitem{Stochastic optimals time scale} \mbox{}
     ...
     \end{klist}
   \kitem{Logicals for stochatic optimals} \mbox{}
     \begin{klist}
...
programs or of using \code{ana\_grid} to create the grid analytically.
The code in \code{ana\_grid.h} was
...
exponential stratification.  \code{ana\_initial.h} is configured
accordingly.
...
\code{upwelling.h}.  We do not have to do anything else.
...
#endif
\end{verbatim}
Here, we have declared that we want a two open sides, two closed
