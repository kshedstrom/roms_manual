...
\href{https://kshedstrom@github.com/kshedstrom/roms.git}{https://kshedstrom@github.com/kshedstrom/roms.git}
via git.
...
and turn on the \code{-g} flag for debugging.
  ...
  \kitem{USE\_MPIF90} \code{USE\_MPI} changes the \code{cpp} flags
  for changing the source code. This flag changes the name of the
  Fortran compiler to \code{mpif90} since \code{mpich} and others
  provide a shell script of this name for finding the required MPI
  files.
